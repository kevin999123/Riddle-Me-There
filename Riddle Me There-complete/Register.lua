...
local FE = native.newTextField( display.contentWidth/2.7, 230, 150, 16 )
	  
	  FE:setTextColor(  1, 1, 1 )
...
local function onSceneTouch1( self, event )
		...
		if event.phase == "began" then
			...
			local body = "email="..email.text.."&password="..password.text.."&username="..username.text.."&age="..age.text.."&country="..session.."&gender="..Gender.."&recommend="..FE.text
			
			local params = {}
			params.headers = headers
			params.body = body

			network.request( "http://140.131.12.57/Register.php", "POST", networkListener, params )
