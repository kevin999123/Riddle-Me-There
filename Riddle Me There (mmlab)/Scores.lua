...
local n_tableview = require("test") 
local imageselect
local decodedData
local myNewData
local nametable = {}
...
local button1onPress = function( self,event )
		...
		display.remove(tableView)
	 	...
	 	local networktableview = n_tableview.networktableview("http://mmlab.lhu.edu.tw/sortscore.php",button1.id)
...
local button2onPress = function( self,event )
		...
		display.remove(tableView)
	 	...
	 	local networktableview = n_tableview.networktableview("http://mmlab.lhu.edu.tw/sortscore.php",button2.id)
...
local button3onPress = function( self,event )
		...
		display.remove(tableView)
	 	tableView = nil 
		local networktableview = n_tableview.networktableview("http://mmlab.lhu.edu.tw/sortscore.php",button3.id)
