...
--------------------------------------------------------------------------------------------------------
	...
	local body = "button="..button1.id.."&email="..nameTable.email
	
	local params = {}
	params.headers = headers
	params.body = body

	network.request( "http://mmlab.lhu.edu.tw/sortcountryscore.php", "POST", networkListener, params )
...
--------------------------------------------------------------------------------------------------------
	...
	local body = "button="..button2.id.."&email="..nameTable.email
...
--------------------------------------------------------------------------------------------------------
	...
	local body = "button="..button3.id.."&email="..nameTable.email
...
-----------------------------------------------------------------------------
	...
	image2 = display.newImage( "muim/friends.png" )
	image2.x = display.contentWidth/1.13
	image2.y = display.contentHeight/2.05
	...
	image7 = display.newImage( "muim/country3.png" )
	image7.x = display.contentWidth/1.2
	image7.y = display.contentHeight/1.69

	image8 = display.newImage( "muim/global1.png" )
	image8.x = display.contentWidth/1.23
	image8.y = display.contentHeight/1.37
